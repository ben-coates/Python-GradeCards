...
class ProgressReport:
    ...
    # Description: Class for parsing and organizing data from a text file report into an organized pattern
    # Paramters: 
    #       rawText     string/lines from file
    def __init__(self, rawText: str):
        self.rawText = io.StringIO(rawText)
        self.data = self.parseReport()

    def parseReport(self):
        studentList = []
        studentData = []
        
        for line in self.rawText.readlines():
